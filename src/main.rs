...
fn main() {
    ...
    let settings_lookup: HashMap<String, String> = temp
        .into_iter()
    ...
    println!("Kept roles: {}", bareclad.role_keeper().lock().unwrap().len());
    println!("Kept appearances: {}", bareclad.appearance_keeper().lock().unwrap().len());
    println!("Kept appearance sets: {}", bareclad.appearance_set_keeper().lock().unwrap().len());
    println!("Kept posits: {}", bareclad.posit_keeper().lock().unwrap().len());
    println!("Role->data type partitions: {:?}", bareclad.role_name_to_data_type_lookup().lock().unwrap());
